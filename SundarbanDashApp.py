...
<div style="position: fixed; 
     bottom: 50px; left: 50px; width: 200px; height: 320px; 
     border:2px solid grey; z-index:9999; font-size:25px;
     background-color:white;
     ">
     <p style="text-align:center; margin-top:5px;"><strong>Blocks</strong></p>
     <p style="color:blue; margin-left:10px;">&#9642; <strong>Kultali</strong></p>
     <p style="color:red; margin-left:10px;">&#9642; <strong>Gosaba</strong></p>
     <p style="color:green; margin-left:10px;">&#9642; <strong>Patharpratima</strong></p>
     <p style="color:black; margin-left:10px;">&#9642; <strong>Sundarban Landscape</strong></p>
     <p style="color:yellow; margin-left:10px;">&#9642; <strong>Villages</strong></p>
</div>
"""
...
title_html = """
<div style="position: fixed; 
     top: 10px; left: 20px; width: 500px; height: 120px; 
     border:2px solid grey; z-index:9999; font-size:30px; text-align:center;
     background-color:white;
     ">
     <p style="margin-top:5px;"><strong>AGRICULTURAL QUERIES IN SUNDARBAN LANDSCAPE</strong></p>
</div>
"""
...
app.layout = html.Div(style={'backgroundColor': 'black', 'border': 'ridge', 'padding': '10px'}, children=[
    dcc.Tabs(id='tabs', value='tab-3', children=[
        ...
        dcc.Tab(label='Crop Advisory', value='tab-1', children=[
            html.H1("CROP ADVISORY", style={'textAlign': 'center', 'color': 'Black', 'font-size': 36}),  # Add the heading here
            html.Div([
                dcc.Dropdown(
                    id='crop-dropdown',
            ...
            html.Div(id='crop-info', style={'margin-top': '20px', 'font-size': '18px'})  # Placeholder for displaying crop information with increased font size
            # Crop Advisory content
        ]),
        dcc.Tab(label='Query Map', value='tab-2', children=[
        ...
        dcc.Tab(label='Soil Map', value='tab-4', children=[
            html.Button(
                id='wwf-button3',
                children=[
                    html.Img(src=image_link, alt='WWF India Logo', style={'width': '100%', 'height': 'auto'}),
            ...
            html.H1('Sundarbans Agricultural Soil Dashboard', style={'textAlign': 'center', 'color': 'White', 'font-size': 36}),
            # Tabs section
            ...
            ], style={'border': 'ridge', 'padding': '10px', 'backgroundColor': 'black'})
        ]),
    ])
])
...
def update_crop_info(selected_crop, selected_month):
    ...
    for index, row in df_filtered.iterrows():
        ...
        html.Div([
            html.B("Sowing:"),
            html.P(row['SOWING'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Seed/Seedbed:"),
            html.P(row['SEED'] + '/' + row['SEEDBED'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Agronomic Practices:"),
            html.P(row['AGRONOMIC PRACTICES'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Fertilization:"),
            html.P(row['FERTILIZATION'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Diseases:"),
            html.P(row['DISEASES'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Pest Control:"),
            html.P(row['PEST CONTROL'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
        html.Div([
            html.B("Pruning/Harvest:"),
            html.P(row['PRUNING/ HARVEST'], style={'font-size': '18px'}),  # Increase font size
        ], style={'margin-bottom': '20px'}),
...
def update_graphs(n_clicks):
    ...
    table = dcc.Graph(
        figure=go.Figure(
            ...
            layout=dict(title='Query Data', height=1000, font=dict(size=16))
        )
    )
    return table
...
def render_content(tab):
    ...
    if tab == 'tab-1':
        ...
        fig_pH.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>pH Range<b>',  # Set legend title
        ...
        colors = ["royalblue", "crimson", "lightseagreen", "orange", "yellow"]
        ...
        fig_ec.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>EC Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)
            ),
            height=1200,  # Set the height of the map
        ...
        oc_colors = ["#ff758f", "#ff4d6d", "#c9184a"]
        ...
        fig_oc.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>OC Range<b>',  # Set legend title
                itemsizing='constant' , # Keep legend item sizes constant
                font=dict(size=16)
            ),
            height=1200,  # Set the height of the map
        ...
        fig_n.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Nitrogen Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
        ...
        fig_p.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Phosphorus Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        for lim, color in zip(limits, k_colors):
            fig_k.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=k_range_names[lim]  # Set legend name based on Potassium (K) range
            ))
        ...
        fig_k.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Potassium (K) Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        for lim, color in zip(limits, colors):
            fig_cu.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=cu_range_names[lim]  # Set legend name based on Cu range
            ))
        ...
        fig_cu.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Cu Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        zn_colors = ["#ff758f", "#ff4d6d", "#c9184a"]
        ...
        for lim, color in zip(limits, zn_colors):
            fig_zn.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=zn_range_names[lim]  # Set legend name based on Zinc range
            ))
        ...
        fig_zn.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Zinc Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        fe_colors = ["#ff758f", "#ff4d6d", "#c9184a"]
        ...
        for lim, color in zip(fe_limits, fe_colors):
            fig_fe.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=fe_range_names[lim]  # Set legend name based on Iron range
            ))
        ...
        fig_fe.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Iron Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        mn_colors = ["#ff758f", "#ff4d6d", "#c9184a"]
        ...
        for lim, color in zip(limits, mn_colors):
            fig_mn.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=mn_range_names[lim]  # Set legend name based on Manganese range
            ))
        ...
        fig_mn.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Manganese Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
            font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        b_colors = ["royalblue", "green", "orange"]
        ...
        for lim, color in zip(limits, b_colors):
            fig_b.add_trace(go.Scatter(
                ...
                y=[None],
                mode='markers',
                marker=dict(color=color,),  # Invisible marker
                name=b_range_names[lim]  # Set legend name based on Boron range
            ))
        ...
        fig_b.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Boron Range<b>',  # Set legend title
                itemsizing='constant',  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        for lim, color in zip(s_limits, s_colors):
            fig_s.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1),  # Invisible marker
                name=s_range_names[lim]  # Set legend name based on Sulphur range
            ))
        ...
        fig_s.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Sulphur Range<b>',  # Set legend title
                itemsizing='constant' ,  # Keep legend item sizes constant
                font=dict(size=16)  # Increase legend font size
            ),
            height=1200,  # Set the height of the map
        ...
        soil_colors = {
            'Clay': 'rgb(255,0,51)',           # Slightly more vibrant shade of red
            'Sandy Clay': 'rgb(255,92,66)',    # Slightly more vibrant shade of orange-red
            'Clay Loam': 'rgb(255,153,102)',   # Slightly more vibrant shade of orange
            'Silty Clay': 'rgb(255,204,153)',  # Slightly more vibrant shade of light orange
            'Silty Clay Loam': 'rgb(255,255,153)',  # Slightly more vibrant shade of pale yellow
            'Sandy Clay Loam': 'rgb(255,255,204)',  # Slightly more vibrant shade of light yellow
            'Sandy Loam': 'rgb(204,255,153)',  # Slightly more vibrant shade of pale green
            'Loam': 'rgb(153,255,102)',        # Slightly more vibrant shade of light green
            'Silt Loam': 'rgb(51,204,102)',    # Slightly more vibrant shade of green
            'Silt': 'rgb(0,153,76)',           # Slightly more vibrant shade of dark green
            'Loamy Sand': 'rgb(0,102,51)',     # Slightly more vibrant shade of deep green
            'Sand': 'rgb(0,76,61)'             # Slightly more vibrant shade of dark turquoise
        }
        ...
        for soil_type, color in soil_colors.items():
            fig_soil_type.add_trace(go.Scatter(
                ...
                mode='markers',
                marker=dict(color=color, opacity=1,),  # Invisible marker
                name=soil_type  # Set legend name based on Soil type
            ))
        ...
        for feature in geo['features']:
            ...
            if village_name != 'Bally':
                try:
                    ...
                    fill_color = soil_colors.get(soil_type, 'rgb(211,211,211)')  # Default to gray for unknown soil types
                    ...
                    if feature['geometry']['type'] == 'Polygon':
                        ...
                        fig_soil_type.add_trace(go.Scattermapbox(
                            ...
                            fillcolor=fill_color,  # Use trace color for filling
                            line=dict(color='black', width=1),
                            hoverinfo='none',  # Hide hover text for polygons
                            showlegend=False,
                        ))
                except IndexError:
                    pass  # Skip villages that don't have corresponding data in the DataFrame
        ...
        # Update layout of the map for Soil Type
        fig_soil_type.update_layout(
            ...
            showlegend=True,
            legend=dict(
                title='<b>Soil Types<b>',  # Set legend title
                font=dict(size=14),  # Set the font size of legend text
            ),
            height=1200,  # Set the height of the map
            width=2150,  # Set the width of the map
        )
    ...
    # Repeat this pattern for other tabs
# Callback for the independent plot
@app.callback(
